...
<div class="container">
	...
	<h1 class="text-mute">Lorem ipsum dolor.</h1>
...
<h1 class="bg-primary text-white">Lorem ipsum dolor.</h1>
<h1 class="bg-success text-white">Lorem ipsum dolor.</h1>
<h1 class="bg-info text-white">Lorem ipsum dolor.</h1>
<h1 class="bg-warning">Lorem ipsum dolor.</h1>
<h1 class="bg-danger text-white">Lorem ipsum dolor.</h1>
<h1 class="bg-secondary text-white">Lorem ipsum dolor.</h1>
<h1 class="bg-dark text-white">Lorem ipsum dolor.</h1>
